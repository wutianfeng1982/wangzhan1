...
@ApiModel(value="ArticlesBlog对象", description="")
public class ArticlesBlog implements Serializable {
    ...
    @TableField("author_pic")
    private String authorPic;

    @ApiModelProperty(value = "文章原作者")
    ...
    @ApiModelProperty(value = "文章内容存储的地址,留作以后升级使用")
    ...
    @ApiModelProperty(value = "文章内容的标签")
    @TableField("tag_id")

...
import com.maike.myblog.consts.CookieConstantItem;
...
public class UserLoginInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
	    ...
	    if (user != null) {
	        ...
	        // 从cookie中取值
	        Cookie userName = CookieUtil.getCookie(request,CookieConstantItem.ADMIN_USER_NAME);
	        if (userName != null) {
	            //String cookieValue = EncryptionUtil.base64Decode(rememberme.getValue());
	        	String cookieValue = userName.getValue();
...
//	                                        .base64Encode(u.getUsername() + ":" + uuidNewString);
//	                                CookieUtil.editCookie(request, response, CookieConstantItem.RememberMe,
//	                                        newCookieValue, null);
//
//	                                // 更新数据库
...
//	            }
	        ...
	        response.sendRedirect(
	                request.getContextPath() + "/backlogin");
	        return false;
	    }

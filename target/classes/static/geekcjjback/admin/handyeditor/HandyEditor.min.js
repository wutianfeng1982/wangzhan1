...
function() {
    window.HE = {
        ...
        getEditor: function(e, i) {
            ...
            return "" != l && ".css" == l.substr(l.length - 4) && this.loadcss(this.config.externalSkin),
        ...
        newdiv: function(e) {
            if (HE.define.mobj.blur(), document.getElementById("HandyEditor_newdiv")) HE.deldiv();
                ...
                } else if ("backcolor" == e) l = HE.getColor(),
                t = "<div>" + HE.define.lang.backcolor + ': <input style="border : solid 2px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_backcolor" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_backcolorok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div><div>" + HE.define.lang.basecolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[0] + "</div><div>" + HE.define.lang.topicolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[1] + "</div>";
        ...
        html: function() {
            if (0 == HE.define.html) {
                ...
                HE.define.html = !0,
                HE.hasClass(this, "HandyEditor_menu_item_valid") || HE.addClass(this, "HandyEditor_menu_item_valid");
                for (var n in HE.config.item) {
                    if ("|" != (d = HE.trim(HE.config.item[n].toLowerCase())) && "html" != d && "about" != d)(t = document.getElementById("HandyEditor_" + HE.define.id + "_" + d)).onclick = null,
                    HE.hasClass(t, "HandyEditor_menu_item_invalid") || HE.addClass(t, "HandyEditor_menu_item_invalid")
                }
                ...
                HE.define.obj.focus(),
                HE.sarea(!0),
                HE.hasClass(this, "HandyEditor_menu_item_valid") && HE.removeClass(this, "HandyEditor_menu_item_valid");
                for (var n in HE.config.item) {
                    var d, t;
                    if ("|" != (d = HE.trim(HE.config.item[n].toLowerCase())) && "html" != d && "about" != d)(t = document.getElementById("HandyEditor_" + HE.define.id + "_" + d)).onclick = HE[d],
                    HE.hasClass(t, "HandyEditor_menu_item_invalid") && HE.removeClass(t, "HandyEditor_menu_item_invalid")
                }
            }
        }
    }
